...
public class TimeToUploadService extends Service {
	...
	class Async {
		...
		private void uploadBlueToothsInfo() {
			...
			NewNetwork.uploadBlueToothInfo(mGroupid, Installation.id(getApplicationContext()), blueToothInfoStr, macAddress,
					new OnResponse<NetworkReturn>("upload_bluetooth_info_android") {
						@Override
